...
insert into produto values (1234567891234, 'Salmao', 'Peixe', 'Makro', now());
...
insert into evento_reposicao values ('Andre', now());
insert into reposicao values (1234567891234, 1, 'e', 10, 'f', 4, 'Frigorificos', 'Andre', now());